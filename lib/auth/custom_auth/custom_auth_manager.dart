...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    listaMercadoAppAuthUserSubject.add(
      ListaMercadoAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ListaMercadoAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ListaMercadoAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ListaMercadoAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    listaMercadoAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ListaMercadoAppAuthUser? currentUser;
